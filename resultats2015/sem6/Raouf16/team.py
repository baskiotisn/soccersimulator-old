...
from strategies import attaquantcentral, defenseurcentral, defenseurgauche, defenseurdroit, Milieu, Milieudefensif
...
team4 = SoccerTeam ("DZPOWER",[Player("Raouf",attaquantcentral()), Player("Yacine",Milieu()), Player("Raouf JR",Milieudefensif()), Player("Yacine JR",defenseurcentral())])
